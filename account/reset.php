...
if(isset($_POST['submit'])){
	...
	if(!isset($error)){
		...
		try {
			...
			$body = "Someone requested that the password be reset. If this was a mistake, just ignore this email and nothing will happen.
			To reset your password, visit the following address: http://s701190940.websitehome.co.uk/chc_deliverymodel_review/account/resetPassword.php?key=$token";
